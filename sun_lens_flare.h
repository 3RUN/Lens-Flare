	...
	STRING *sun_lens_g_tga = "LF_sunG.tga";
	STRING *sun_lens_h_tga = "LF_sunH.tga";
	STRING *sun_lens_i_tga = "LF_sunI.tga";
	STRING *sun_lens_mdl = "LS_lens.mdl";
